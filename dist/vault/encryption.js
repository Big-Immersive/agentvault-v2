...
import { ENCRYPTION_ALGO, SCRYPT_N, SCRYPT_R, SCRYPT_P, SCRYPT_KEYLEN, SALT_BYTES, IV_BYTES, PASSPHRASE_ENV, } from '../config/defaults.js';
...
export function getPassphrase(projectDir) {
    ...
    throw new Error('No passphrase found. Set AGENTVAULT_PASSPHRASE env var or create .agentvault/.passphrase file.');
}
...
export function readEncryptedFile(filePath, passphrase, fallback) {
...
export function writeEncryptedFile(filePath, data, passphrase) {
