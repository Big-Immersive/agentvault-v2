...
export type LicenseAccessType = 'unlimited' | 'time_locked' | 'access_limited' | 'time_and_access' | 'subscription';
...
export type McpErrorCode = 'KEY_NOT_FOUND' | 'VAULT_LOCKED' | 'VAULT_FULL' | 'BUDGET_EXCEEDED' | 'RATE_LIMITED' | 'UNAUTHORIZED' | 'INVALID_INPUT' | 'DECRYPTION_FAILED' | 'INTERNAL_ERROR' | 'LICENSE_EXPIRED' | 'ACCESS_LIMIT_REACHED';
/** MCP tool response */
